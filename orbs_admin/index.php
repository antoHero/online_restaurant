            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <?php
                        ...
                        $get = "SELECT * FROM food LIMIT $start, $per_page";
                        ...
                        if(mysqli_num_rows($query) > 0) {
                            ...
                            while($row = mysqli_fetch_assoc($query)){
                                ...
                                $result .= "<tr>
                                                ...
                                                <td>$price</td>
                                                <td>$category</td>
                                                <td><a class='btn btn-danger' href='index.php?delete=".$id."' onclick='return check();'><i class='pe-7s-close-circle'></i>Delete</a></td>
                                            </tr>";
                                $x++;
                            }
